...
public class SFMConfig {
    ...
    static {
        final Pair<SFMServerConfig, ModConfigSpec> serverSpecPair = new ModConfigSpec.Builder()
                .configure(SFMServerConfig::new);
        SERVER_SPEC = serverSpecPair.getRight();
        SERVER = serverSpecPair.getLeft();
        final Pair<SFMClientConfig, ModConfigSpec> clientSpecPair = new ModConfigSpec.Builder()
